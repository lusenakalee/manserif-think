...
export default function ProjectPage({ params }: PageProps) {
  ...
  return (
    <main
      ref={containerRef}
      className="h-[100vh] w-full overflow-hidden bg-[#F5F2ED]"
    >
      ...
      <div ref={wrapperRef} className="flex h-full w-max will-change-transform">
        ...
        {project.images.map((src, index) => (
          ...
          >
            <div
              className={`reveal-image-wrapper relative w-full aspect-[4/3] md:w-auto md:h-[70vh] ${index % 2 === 0 ? "md:aspect-[16/9]" : "md:aspect-[3/4]"}`}
            >
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm font-light">
                  <li className="overflow-hidden">
                    <a
                      href="mailto:warren@manserifthink.com"
