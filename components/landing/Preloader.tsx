...
const Preloader = () => {
    ...
    useGSAP(
        () => {
            ...
            const images = gsap.utils.toArray<HTMLElement>(el.querySelectorAll(".preloader-image"));
            ...
            tl.to(firstImage, { scale: 1, duration: duration, ease: "power3.out" });


            tl.to(
                notFirstImages,
                { scale: 1, duration: duration, ease: "power3.out", stagger: 0.12 },
                `<${duration / 3}`,
            );
    ...
    return (
        ...
        >
            <div className="preloader-backdrop absolute inset-x-0 bottom-0 bg-[#F3F0E7]" style={{ height: "100%" }} />
