...
const demoItems = [
  { link: '#', text: 'LE DIVIN À TRAVERS MES YEUX', image: '/images/eyes.webp' },
  ...
  return (
    <div>
        <div className="mx-auto bg-[#120F17] py-5 lg:mx-0 justify center items-center w-full text-center">
          <h2 className="text-4xl font-semibold tracking-tight text-pretty text-white sm:text-5xl">Upcoming Exhibition</h2>
